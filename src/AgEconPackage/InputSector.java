...
class InputSector {
    ...
    InputSector(String name, int earlyAmnt, double earlyCost, int midAmnt, double midCost, int fullAmnt,
                double fullCost) {
        this.name = name;
    ...
    boolean updateAmnt(Seed_Type type, Integer amnt) {
    ...
    double getPrice(Seed_Type type) {
        switch (type) {
            case EARLY:
                return earlyPrice;
            case MID:
    ...
    private void setPrice(HashMap<Seed_Type, Double> seedPrices) {
