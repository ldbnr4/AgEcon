...
class CompanyThread implements Runnable {
    private JLabel erlA, erlP, midA, midP, fullA, fullP;
    String name;
    private InputSector DBinput;
    private Boolean inputComp;
    JFrame page;

    private JLabel amnt, price, dt;
    private MarketingSector DBmarketingComp;


    CompanyThread(BuySeedsPage page, String name, JLabel eAmnt, JLabel ePrice, JLabel mAmnt, JLabel mPrice, JLabel fAmnt, JLabel fPrice) {
        this.erlA = eAmnt;
        this.erlP = ePrice;
        this.midA = mAmnt;
        this.midP = mPrice;
    ...
    CompanyThread(MarketingDealsPage page, String name, JLabel numOfBushels, JLabel pricePerBushel, JLabel date) {
